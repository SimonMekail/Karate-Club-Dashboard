...
export const AddUserModal = ({ show, onHide, refreshData }) => {
  const { user } = AuthData();
  ...
  const removeImage = () => {
    ...
    document.getElementById("add-user-image").value = "";
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userResponse.status === 200 || userResponse.status === 201) {
        toast.success(userResponse.data?.message || "تم إضافة المستخدم بنجاح", {
          id: toastId,
        });
        ...
        <div className="d-flex align-items-center">
          ...
          <div>
            ...
            <p className="small mb-0 opacity-75" style={{ color: "white" }}>
              املأ النموذج التالي لإضافة مستخدم جديد للنادي
            </p>
          </div>
        </div>
      </Modal.Header>
        ...
        <div className="pt-3">
          <Form onSubmit={handleSubmit}>
            <Row className="g-3">
              {}
              <Col xs={12}>
                <Form.Group controlId="add-user-image" className="mb-3">
                  <Form.Label
                    className="fw-medium"
              ...
              {}
              <Col md={6}>
                <Form.Group controlId="add-user-name" className="mb-3">
              ...
              {}
              <Col md={6}>
                <Form.Group controlId="add-user-username" className="mb-3">
              ...
              {}
              {/* <Col md={6}>
                <Form.Group controlId="add-user-email" className="mb-3">
                  {commonField("البريد الإلكتروني", "email")}
                  <Form.Control
                    type="email"
              ...
              {}
              <Col md={6}>
                <Form.Group controlId="add-user-number" className="mb-3">
              ...
              {}
              <Col md={6}>
                <Form.Group controlId="add-user-address" className="mb-3">
              ...
              {}
              <Col md={6}>
                <Form.Group controlId="add-user-password" className="mb-3">
                  {commonField("كلمة المرور", "password")}
                  <Form.Control
                    type="password"
              ...
              <Col md={6}>
                <Form.Group
                  controlId="add-user-confirmPassword"
                  className="mb-3"
                >
                  {commonField("تأكيد كلمة المرور", "confirmPassword")}
                  <Form.Control
                    type="password"
              ...
              {}
              {/* <Col md={6}>
                <Form.Group controlId="add-user-role" className="mb-3">
                  <Form.Label
                    className="fw-medium"
                    style={{ color: "var(--karate-text)" }}
                  >
